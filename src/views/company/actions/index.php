...
<?$curActive = (isset($_REQUEST['ACTIVE']) && $_REQUEST['ACTIVE'] == 'Y') ? 'Y' : ((isset($_REQUEST['ACTIVE']) && $_REQUEST['ACTIVE'] == 'N') ? 'N' : '');
global $arrFilter;
$arrFilter = array("PROPERTY_HIDE_ACTION" => false);
if ($curActive != '') {
    if ($curActive == 'Y') {
        $arrFilter = array(
            "PROPERTY_HIDE_ACTION" => false,
            array(
                "LOGIC" => "OR",
        ...
        $arrFilter = array("PROPERTY_HIDE_ACTION" => false, "<DATE_ACTIVE_TO" => ConvertTimeStamp(strtotime(date("Y-m-d") . ' 00:00:00'),"FULL"), "!DATE_ACTIVE_TO" => false);
    }
}
